...
function initPopButtons() {
    let rn = (min, max) => (Math.floor(Math.random() * (max - min + 1) + min)).toString();
    ...
    $('.pop-button').each(function(){
        ...
        $this.on('mousedown', function () {
            ...
            p1.animate({ left: rn(100, 200), top: rn(40, 120), opacity: "0" }, 850, "swing", function () {
                $(this).css({ left: "50%", top: "50%", opacity: "1" })
            });
            p2.animate({ left: rn(-10, 40), top: rn(40, 150), opacity: "0" }, 850, "swing", function () {
                $(this).css({ left: "50%", top: "50%", opacity: "1" })
            });
            p3.animate({ left: rn(40, 105), top: rn(90, 156), opacity: "0" }, 850, "swing", function () {
                $(this).css({ left: "50%", top: "50%", opacity: "1" })
            });
            p4.animate({ left: rn(30, 100), top: rn(-10, -65), opacity: "0" }, 850, "swing", function () {
                $(this).css({ left: "50%", top: "50%", opacity: "1" })
            });
            p5.animate({ left: rn(-10, -55), top: rn(-10, -45), opacity: "0" }, 850, "swing", function () {
                $(this).css({ left: "50%", top: "50%", opacity: "1" })
            });
            p6.animate({ left: rn(130, 220), top: rn(10, -25), opacity: "0" }, 850, "swing", function () {
                $(this).css({ left: "50%", top: "50%", opacity: "1" })
            });
            p7.animate({ left: rn(-10, 30), top: rn(-130, -60), opacity: "0" }, 850, "swing", function () {
                $(this).css({ left: "50%", top: "50%", opacity: "1" })
            });
        });
    })
